...
(function(){
    ...
    angular.module('ngEasyCal').directive('easyCalendar', ['$http', 'calendarService', '$route',  function($http, calendarService, $route){
        return {
            restrict: "EA",
            scope: {
                ezEvents: "=",
			...
			templateUrl: "../view/partials/template.html", //Set this to the path of your ng-easy-template.html
